# Generated by Django 3.1.1 on 2024-08-10 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('law_firm', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cid_number', models.CharField(default=' ', max_length=20, unique=True)),
                ('permanent_address', models.CharField(default=' ', max_length=20)),
                ('some_date_field', models.DateTimeField(default='2024-08-10 12:00:00')),
                ('present_address', models.CharField(default=' ', max_length=20)),
                ('contact_number', models.CharField(default='+975-', max_length=15)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('case_id', models.CharField(default='0000', max_length=20, unique=True)),
                ('outcome', models.TextField(default=' ')),
                ('impact', models.TextField(default=' ')),
                ('case_status', models.CharField(choices=[('UA', 'Under Assesment'), ('P', 'Pending'), ('D', 'Court and Disposed')], default=' ', max_length=50)),
