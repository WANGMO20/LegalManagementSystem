...
def add_staff(request):
    ...
    context = {'form': form, 'page_title': 'Add Service Provider'}
    if request.method == 'POST':
        if form.is_valid():
            first_name = form.cleaned_data.get('first_name')
            last_name = form.cleaned_data.get('last_name')
            email = form.cleaned_data.get('email')
            law_firm= form.cleaned_data.get('law_firm')
            ...
            try:
                ...
                user.gender = gender
                user.law_firm = law_firm
                user.contact_number = contact_number
                user.license_number = license_number
                user.staff.service_types = service_type
                user.save()
...
def add_student(request):
    ...
    context = {'form': student_form, 'page_title': 'Add Client'}
    if request.method == 'POST':
        if student_form.is_valid():
            ...
            cid_number = student_form.cleaned_data.get('cid_number')
            permanent_address = student_form.cleaned_data.get('permanent_address')
            dob = student_form.cleaned_data.get('dob')
            present_address = student_form.cleaned_data.get('present_address')
            contact_number = student_form.cleaned_data.get('contact_number')
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                subject.case_status = case_status
...
def manage_course(request):
    ...
    context = {
        'courses': courses,
        'page_title': 'Manage Service Provided'
    }
...
def view_student_leave(request):
    if request.method != 'POST':
        ...
        context = {
            'allLeave': allLeave,
            'page_title': 'Application From Client'
        }
...
def admin_notify_staff(request):
    ...
    context = {
        'page_title': "Send Notifications To Lawyer",
        'allStaff': staff
    }
...
def admin_notify_student(request):
    ...
    context = {
        'page_title': "Send Notifications To Clients",
        'students': student
    }
